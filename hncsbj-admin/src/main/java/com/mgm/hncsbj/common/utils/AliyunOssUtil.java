package com.mgm.hncsbj.common.utils;
...
import com.mgm.hncsbj.common.config.ProjectConfiguration;
import com.mgm.hncsbj.common.exception.BaseException;
import com.mgm.hncsbj.common.vo.OssPolicyVO;
import com.mgm.hncsbj.modules.sys.entity.SysDownloadCenter;
import com.mgm.hncsbj.modules.sys.enums.SseNotifyType;
import com.mgm.hncsbj.modules.sys.mapper.SysDownloadCenterMapper;
import com.mgm.hncsbj.modules.sys.service.SseService;
...
public class AliyunOssUtil {
    ...
    public <D> void uploadExcel(final Long sysDownloadCenterId, final List<D> list) {
        ...
        sysDownloadCenter.setStatus("SUCCESS"); // 设置成功状态
