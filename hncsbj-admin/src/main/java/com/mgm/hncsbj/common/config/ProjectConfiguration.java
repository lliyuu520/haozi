package com.mgm.hncsbj.common.config;
...
public class ProjectConfiguration {
     ...
     * 微信小程序订阅消息配置项
     */
    private final WxMaSubscribeTemplate wxMaSubscribeTemplate = new WxMaSubscribeTemplate();
     ...
     */
    @Data
    public static class WxMaSubscribeTemplate {
        /**
         * 模板ID
         */
