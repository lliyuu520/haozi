	...
	<el-card class="monitor-server">
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span>CPU</span>
					<el-button :icon="Refresh" circle size="small" @click="refreshCpuInfo" />
				</div>
			</template>
		...
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span>系统内存</span>
					<el-button :icon="Refresh" circle size="small" @click="refreshMemInfo" />
				</div>
			</template>
			<el-descriptions :column="2" border>
		...
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span>JVM信息</span>
					<el-button :icon="Refresh" circle size="small" @click="refreshJvmInfo" />
				</div>
			</template>
			<el-descriptions :column="2" border>
		...
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span>系统信息</span>
					<el-button :icon="Refresh" circle size="small" @click="refreshSysInfo" />
				</div>
			</template>
			<el-descriptions :column="2" border>
		...
		<el-card class="box-card">
			<template #header>
				<div class="card-header">
					<span>磁盘信息</span>
					<el-button :icon="Refresh" circle size="small" @click="refreshDiskInfo" />
				</div>
			</template>
			<el-table :data="data.disks" header-align="center" style="width: 100%">
				...
				<el-table-column align="center" label="总内存" prop="total" />
				<el-table-column align="center" label="已用内存" prop="used" />
				<el-table-column align="center" label="空闲内存" prop="free" />
