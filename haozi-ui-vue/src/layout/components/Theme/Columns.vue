<template>
	<el-container class="layout-container layout-columns">
		<el-aside :class="sidebarClass" class="layout-sidebar aside-expend">
			...
			<el-scrollbar>
				<div class="columns-menu">
					<router-link to="/home">
						<div :class="{ active: menuPath === '/home' }" class="columns-menu-item">
		...
		<el-container>
			<el-header :style="layoutHeaderHeight" class="layout-header">
				<div :class="headerClass" class="navbar-container">
					<NavbarLeft />
					<NavbarRight />
				</div>
			</el-header>
